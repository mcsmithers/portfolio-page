...
>
	...
	<div class="flex flex-col gap-4 items-center justify-center">
		<p>
            ...
            <a class="text-violet-400" target="_blank"
				href="https://linkedin.com/in/christinsmithers">Here
                 <sup>
		...
		<p>
			...
			<a class="text-violet-400" target="_blank" href="https://github.com/mcsmithers">mcsmithers
                <sup>
                <span class="text-xs scale-75 pl-0.5">
                    <i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"></i>
                </span>
